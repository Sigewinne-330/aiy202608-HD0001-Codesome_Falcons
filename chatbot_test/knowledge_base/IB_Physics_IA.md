...
```mermaid
flowchart TD
    Start["Three students (A, B, C) collaborate discussing possible topics of research"]
    Teacher["Teacher ensures students develop independent research"]
    ...
    %% 学生 A
    subgraph Student A
        A1["Student A develops their research question"] --> A2["Methodology developed through collaboration"]
        A2 --> A3["Student A runs their experiment"]
        A3 --> A4["Student A authors their scientific investigation report"]
        A3 --- A_assist["Student B assists student A to run the experiment"]
    end

    %% 学生 B
    subgraph Student B
        B1["Student B develops their research question"] --> B2["Methodology developed through collaboration"]
        B2 --> B3["Student B runs their experiment"]
        B3 --> B4["Student B authors their scientific investigation report"]
        B3 --- B_assist["Students A and C assist student B to run the experiment"]
    end

    %% 学生 C
    subgraph Student C
        C1["Student C develops their research question"] --> C2["Methodology developed through collaboration"]
        C2 --> C3["Student C runs their experiment"] --> C4["Student C authors their scientific investigation report"]
    end
```
