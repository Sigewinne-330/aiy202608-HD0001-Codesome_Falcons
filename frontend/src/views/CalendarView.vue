...
const PROCESS_PALETTE = [
  { bg: 'color-mix(in srgb, var(--ib-success) 12%, var(--ib-surface))', dot: 'var(--ib-success)', text: 'var(--ib-success)' },
  { bg: 'var(--ib-primary-soft)', dot: 'var(--ib-primary-strong)', text: 'var(--ib-primary-strong)' },
  { bg: 'color-mix(in srgb, var(--ib-warning) 13%, var(--ib-surface))', dot: 'var(--ib-warning)', text: 'var(--ib-warning)' },
  { bg: 'color-mix(in srgb, var(--ib-danger) 10%, var(--ib-surface))', dot: 'var(--ib-danger)', text: 'var(--ib-danger)' },
  { bg: 'color-mix(in srgb, var(--ib-success) 12%, var(--ib-surface))', dot: 'var(--ib-success)', text: 'var(--ib-success)' },
  { bg: 'var(--ib-primary-soft)', dot: 'var(--ib-primary)', text: 'var(--ib-primary-strong)' },
  { bg: 'color-mix(in srgb, var(--ib-warning) 13%, var(--ib-surface))', dot: 'var(--ib-warning)', text: 'var(--ib-warning)' },
  { bg: 'color-mix(in srgb, var(--ib-info) 12%, var(--ib-surface))', dot: 'var(--ib-primary)', text: 'var(--ib-primary-strong)' },
]

function pillColor(item) {
  if (item.type === 'deadline') return { bg: 'color-mix(in srgb, var(--ib-warning) 13%, var(--ib-surface))', dot: 'var(--ib-warning)', text: 'var(--ib-warning)' }
...
<style scoped>
.calendar-workspace { min-height: calc(100vh - 64px); padding: 30px clamp(22px, 4vw, 58px) 38px; color: var(--ib-text); }
.calendar-heading { display: flex; align-items: flex-end; justify-content: space-between; gap: 24px; margin-bottom: 22px; }
.eyebrow { margin-bottom: 4px; color: var(--ib-primary); font-size: 10px; font-weight: 800; letter-spacing: .16em; }
.calendar-heading h1 { font-size: clamp(27px, 3vw, 38px); line-height: 1.1; letter-spacing: -.04em; }
.calendar-heading p { margin-top: 8px; color: var(--ib-text-secondary); font-size: 13px; }
.calendar-heading__stats { display: flex; gap: 10px; }
.calendar-heading__stats > div { min-width: 106px; padding: 12px 16px; border-radius: 15px; background: var(--ib-surface); border: 1px solid var(--ib-border); }
.calendar-heading__stats strong, .calendar-heading__stats span { display: block; }
.calendar-heading__stats strong { font-size: 20px; }
.calendar-heading__stats span { margin-top: 2px; color: var(--ib-text-muted); font-size: 10px; }
.calendar-card { overflow: hidden; border: 1px solid var(--ib-border); background: var(--ib-surface) !important; box-shadow: var(--ib-shadow-card); }
.calendar-toolbar { min-height: 70px; display: flex; align-items: center; justify-content: space-between; gap: 20px; padding: 14px 18px; border-bottom: 1px solid var(--ib-border); }
...
.calendar-legend > span { display: inline-flex; align-items: center; gap: 6px; color: var(--ib-text-muted); font-size: 11px; }
.calendar-legend i { width: 12px; height: 12px; border-radius: 3px; }
.legend-todo { background: var(--ib-primary); }
.legend-process { background: var(--ib-success); }
.legend-personal { background: transparent; border: 1.5px dashed var(--ib-success); }
.legend-urgent { background: transparent; border: 1.5px solid var(--ib-danger); }
.legend-deadline {
  width: 21px; height: 21px;
  border-radius: 50%;
  background: transparent;
  border: 1.5px solid var(--ib-warning);
  position: relative;
}
...
.weekday-grid { border-bottom: 1px solid var(--ib-border); background: var(--ib-primary-soft); }
.weekday-grid > div { padding: 11px 12px; color: var(--ib-text-muted); text-align: center; font-size: 10px; font-weight: 750; letter-spacing: .04em; }
.month-grid { position: relative; }
.calendar-day { min-height: clamp(112px, 14vh, 148px); padding: 10px; border-right: 1px solid var(--ib-border); border-bottom: 1px solid var(--ib-border); background: var(--ib-surface); transition: background .15s; }
.calendar-day:nth-child(7n) { border-right: 0; }
.calendar-day:nth-last-child(-n+7) { border-bottom: 0; }
.calendar-day:hover { background: var(--ib-primary-soft); }
.calendar-day--muted { background: var(--ib-surface); opacity: .55; }
.calendar-day--weekend:not(.calendar-day--muted) { background: var(--ib-primary-soft); }
...
.calendar-day__number { width: 26px; height: 26px; display: grid; place-items: center; border-radius: 9px; color: var(--ib-text); font-size: 12px; font-weight: 650; }
.calendar-day--today .calendar-day__number { color: var(--ib-on-primary); background: var(--ib-primary); }
.today-label { color: var(--ib-primary); font-size: 9px; font-weight: 750; }
.item-count { min-width: 18px; height: 18px; display: grid; place-items: center; padding: 0 5px; border-radius: 999px; color: var(--ib-text-secondary); background: var(--ib-primary-soft); font-size: 9px; }
...
.schedule-pill--todo:hover { background: var(--ib-background); }
...
.schedule-pill--personal-todo:hover { background: var(--ib-background); }
...
.schedule-pill--urgent {
  box-shadow: inset 0 0 0 1.5px var(--ib-danger);
  border-radius: 7px;
}
/* todo 的 urgent：竖线变红 */
...
.more-items { border: 0; padding: 2px 5px; color: var(--ib-text-secondary); background: transparent; cursor: pointer; text-align: left; font-size: 9px; font-weight: 650; }
.more-items:hover { color: var(--ib-primary); }
/* 单日详情弹窗 */
.day-dialog__title { display: flex; align-items: center; gap: 8px; padding: 18px 20px 10px; font-size: 16px; }
.day-dialog__count { color: var(--ib-text-muted); font-size: 12px; font-weight: 500; }
...
.calendar-loading { position: absolute; inset: 0; z-index: 2; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; color: var(--ib-text-secondary); background: var(--ib-surface); backdrop-filter: blur(3px); font-size: 12px; }
