...
const categoryDefinitions = [
  { key: 'IA', color: 'var(--ib-primary)', softColor: 'var(--ib-primary-soft)', vuetifyColor: 'primary', groups: null },
  { key: 'EE', color: 'var(--ib-primary)', softColor: 'var(--ib-primary-soft)', vuetifyColor: 'deep-purple', groups: null },
  { key: 'TOK', color: 'var(--ib-warning)', softColor: 'color-mix(in srgb, var(--ib-warning) 13%, var(--ib-surface))', vuetifyColor: 'warning', groups: ['Essay', 'Exhibition'] },
  { key: 'CAS', color: 'var(--ib-text)', softColor: 'color-mix(in srgb, var(--ib-success) 12%, var(--ib-surface))', vuetifyColor: 'success', groups: ['Experience', 'Project', 'Reflection', 'Evidence'] },
]
...
<style scoped>
.progress-page { position: relative; min-height: calc(100vh - 64px); padding: 28px clamp(22px, 5vw, 70px) 110px; color: var(--ib-text); }
...
.eyebrow { color: var(--ib-primary); font-size: 10px; font-weight: 800; letter-spacing: .16em; }
.page-header h1, .category-header h1 { margin-top: 4px; font-size: clamp(28px, 3vw, 39px); letter-spacing: -.04em; }.page-header p, .category-header p { margin-top: 7px; color: var(--ib-text-secondary); font-size: 12px; }
.overall-card { display: grid; grid-template-columns: 1.2fr auto 1fr; align-items: center; gap: 38px; padding: 28px 32px; border: 1px solid var(--ib-border); background: var(--ib-surface) !important; box-shadow: var(--ib-shadow-card); }
.section-tag { display: inline-flex; padding: 4px 9px; border-radius: 999px; color: var(--ib-primary); background: var(--ib-primary-soft); font-size: 10px; font-weight: 750; }.overall-card__copy h2 { margin-top: 12px; font-size: 22px; }.overall-card__copy p { max-width: 410px; margin-top: 7px; color: var(--ib-text-muted); font-size: 11px; }.overall-next { display: flex; align-items: center; gap: 6px; margin-top: 13px; color: var(--ib-text-secondary); font-size: 10px; }
.overall-score strong, .overall-score span { display: block; }.overall-score strong { font-size: 21px; }.overall-score span { color: var(--ib-text-muted); font-size: 9px; }
.overall-bars { display: grid; gap: 17px; }.status-bar > div { display: flex; justify-content: space-between; margin-bottom: 7px; color: var(--ib-text-muted); font-size: 10px; }.status-bar strong { color: var(--ib-text); }
.category-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 18px; margin-top: 18px; }.category-card { padding: 22px; border: 1px solid var(--ib-border); border-radius: 20px; color: var(--ib-text); background: var(--ib-surface); box-shadow: var(--ib-shadow-card); cursor: pointer; text-align: left; transition: transform .18s, box-shadow .18s; }.category-card:hover { transform: translateY(-3px); box-shadow: var(--ib-shadow-card); }
.category-card__header { display: flex; align-items: center; gap: 11px; }.category-icon { min-width: 47px; height: 39px; display: inline-grid; place-items: center; padding: 0 10px; border-radius: 12px; font-size: 14px; font-weight: 850; }.category-icon.large { height: 54px; min-width: 66px; border-radius: 16px; font-size: 18px; }.category-meta { flex: 1; color: var(--ib-text-muted); font-size: 10px; }.category-card__status { display: flex; align-items: baseline; gap: 9px; margin: 18px 0 14px; }.category-card__status strong { font-size: 24px; }.category-card__status span { color: var(--ib-text-secondary); font-size: 11px; }
.card-bars { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }.card-bars > div > span, .card-bars > div > strong { display: inline-block; margin-bottom: 6px; font-size: 9px; }.card-bars > div > span { color: var(--ib-text-muted); }.card-bars > div > strong { float: right; color: var(--ib-text-secondary); }.category-next { display: flex; align-items: center; gap: 5px; margin-top: 14px; overflow: hidden; color: var(--ib-text-muted); font-size: 9px; text-overflow: ellipsis; white-space: nowrap; }
.category-summary-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 14px; }.category-summary-grid .v-card { padding: 18px; border: 1px solid var(--ib-border); background: var(--ib-surface) !important; }.category-summary-grid span, .category-summary-grid strong, .category-summary-grid small { display: block; }.category-summary-grid span { color: var(--ib-text-muted); font-size: 10px; }.category-summary-grid strong { margin: 7px 0 10px; font-size: 20px; }.category-summary-grid small { overflow: hidden; color: var(--ib-text-muted); font-size: 9px; text-overflow: ellipsis; white-space: nowrap; }.category-summary-grid .next-date { font-size: 14px; }
.group-tabs { display: flex; gap: 8px; margin: 20px 0 14px; overflow-x: auto; }.group-tabs button { display: inline-flex; align-items: center; gap: 8px; padding: 8px 13px; border: 1px solid var(--ib-border); border-radius: 999px; color: var(--ib-text-secondary); background: var(--ib-surface); cursor: pointer; font-size: 11px; }.group-tabs button.active { border-color: var(--ib-border-strong); color: var(--ib-primary); background: var(--ib-primary-soft); }.group-tabs span { min-width: 18px; padding: 1px 5px; border-radius: 999px; color: var(--ib-text-secondary); background: var(--ib-primary-soft); font-size: 9px; text-align: center; }
.timeline-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-top: 18px; }.timeline-card { padding: 20px; border: 1px solid var(--ib-border); border-radius: 18px; color: var(--ib-text); background: var(--ib-surface); cursor: pointer; text-align: left; transition: transform .17s, box-shadow .17s; }.timeline-card:hover { transform: translateY(-2px); box-shadow: var(--ib-shadow-card); }.timeline-card__top { display: grid; grid-template-columns: auto minmax(0,1fr) auto; align-items: center; gap: 11px; }.timeline-avatar { width: 43px; height: 43px; display: grid; place-items: center; border-radius: 13px; font-size: 10px; font-weight: 850; }.timeline-card h2 { overflow: hidden; font-size: 14px; text-overflow: ellipsis; white-space: nowrap; }.timeline-card p { margin-top: 3px; color: var(--ib-text-muted); font-size: 9px; }.timeline-card__progress { display: flex; align-items: baseline; gap: 8px; margin: 17px 0 8px; }.timeline-card__progress strong { font-size: 22px; }.timeline-card__progress span { color: var(--ib-text-muted); font-size: 10px; }.timeline-card__meta { display: flex; flex-wrap: wrap; gap: 11px; margin-top: 13px; color: var(--ib-text-muted); font-size: 9px; }.timeline-card__meta span { display: inline-flex; align-items: center; gap: 4px; }.risk-text-high { color: var(--ib-danger) !important; }.risk-text-medium { color: var(--ib-warning) !important; }.risk-text-low { color: var(--ib-text) !important; }
.category-empty { min-height: 390px; display: flex; flex-direction: column; align-items: center; justify-content: center; margin-top: 18px; padding: 36px; border: 1px dashed var(--ib-border-strong); border-radius: 22px; color: var(--ib-text-secondary); background: var(--ib-surface); text-align: center; }.category-empty > span { width: 76px; height: 76px; display: grid; place-items: center; border-radius: 23px; color: var(--ib-primary); background: var(--ib-primary-soft); }.category-empty h2 { margin-top: 16px; color: var(--ib-text); font-size: 18px; }.category-empty p { max-width: 430px; margin-top: 6px; font-size: 11px; }.category-empty > div { display: flex; gap: 9px; margin-top: 18px; }
.dialog-title { padding: 22px 24px 8px; font-weight: 750; }.dialog-body { padding: 18px 24px 4px !important; }.dialog-actions { padding: 12px 24px 22px; }.page-loading { position: fixed; inset: 64px 0 0; z-index: 4; display: grid; place-items: center; background: var(--ib-surface); backdrop-filter: blur(3px); }
