...
<style scoped>
.memory-heading { display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; padding-bottom: 18px; border-bottom: 1px solid var(--ib-border); }.memory-heading h2 { margin: 0; font-size: 21px; }.memory-heading p,.danger-zone p { margin: 5px 0 0; color: var(--ib-text-secondary); font-size: 12px; }
.filters { display: grid; grid-template-columns: 1.5fr 1fr 1fr 1fr auto; gap: 8px; margin: 18px 0; }.memory-list { display: grid; gap: 10px; }.memory-card { padding: 15px; border: 1px solid var(--ib-border); border-radius: 14px; background: var(--ib-surface); }.memory-card__top { display: flex; justify-content: space-between; gap: 10px; }.chips { display: flex; flex-wrap: wrap; gap: 6px; }.memory-card h3 { margin: 10px 0 8px; font-size: 14px; line-height: 1.55; }.memory-meta { display: flex; flex-wrap: wrap; gap: 14px; color: var(--ib-text-secondary); font-size: 11px; }.empty-state { display: grid; justify-items: center; gap: 7px; padding: 48px 20px; color: var(--ib-text-secondary); text-align: center; }.danger-zone { display: grid; grid-template-columns: 1fr auto auto; align-items: center; gap: 14px; margin-top: 28px; padding: 16px; border: 1px solid var(--ib-danger); border-radius: 14px; background: color-mix(in srgb, var(--ib-danger) 10%, var(--ib-surface)); }.danger-zone small { color: var(--ib-text-secondary); }.date-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }.text-button { border: 0; background: none; text-decoration: underline; cursor: pointer; }
