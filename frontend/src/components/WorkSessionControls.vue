...
<style scoped>
.work-controls{margin:0 18px 14px;padding:13px;border:1px solid var(--ib-border-strong);border-radius:15px;background:var(--ib-primary-soft)}.work-controls__title{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:10px}.work-controls__title div{display:grid}.work-controls__title span{color:var(--ib-text-secondary);font-size:10px}.timer{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:10px 0;color:var(--ib-text-secondary);font-size:11px}.timer strong{font-variant-numeric:tabular-nums;font-size:17px;color:var(--ib-text)}.timer span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.work-actions{display:flex;flex-wrap:wrap;gap:6px}
</style>
