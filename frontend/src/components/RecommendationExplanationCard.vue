...
<style scoped>
.explanation-card{padding:17px;border:1px solid var(--ib-border-strong);border-radius:15px;background:var(--ib-surface)}.explanation-head{display:flex;justify-content:space-between;gap:12px}.explanation-head h3{margin:0;font-size:15px}.explanation-head p{margin:5px 0 0;color:var(--ib-text-secondary);font-size:12px}.explanation-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:14px}.explanation-section{padding:13px;border-radius:12px}.deterministic{background:var(--ib-primary-soft);border-left:3px solid var(--ib-primary)}.personal{background:var(--ib-primary-soft);border-left:3px solid var(--ib-primary)}.section-label{display:flex;align-items:center;gap:5px;margin-bottom:8px;color:var(--ib-text);font-size:12px;font-weight:700}.explanation-section strong{font-size:16px}.explanation-section ul{margin:8px 0;padding-left:17px;color:var(--ib-text-secondary);font-size:12px;line-height:1.7}.explanation-section small{color:var(--ib-text-secondary);font-size:11px}.rank-row{display:flex;align-items:center;gap:6px;color:var(--ib-text-secondary);font-size:12px}.range{display:grid;gap:2px;margin-top:12px}.range span{color:var(--ib-text-secondary);font-size:11px}.evidence{display:flex;flex-wrap:wrap;gap:5px;margin-top:12px}.explanation-footer{display:flex;justify-content:space-between;gap:10px;margin-top:13px;color:var(--ib-text-secondary);font-size:11px}.explanation-footer strong{color:var(--ib-text)}.alternatives{display:flex;flex-wrap:wrap;align-items:center;gap:6px;margin-top:12px;color:var(--ib-text-secondary);font-size:12px}.alternatives button{padding:5px 9px;border:1px solid var(--ib-border-strong);border-radius:8px;background:var(--ib-surface);color:var(--ib-primary);cursor:pointer}.alternatives button:hover{background:var(--ib-primary-soft)}@media(max-width:650px){.explanation-grid{grid-template-columns:1fr}.explanation-footer{align-items:flex-start;flex-direction:column}}
</style>
