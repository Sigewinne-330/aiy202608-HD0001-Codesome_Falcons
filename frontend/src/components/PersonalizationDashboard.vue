    ...
    <template v-else-if="data">
      ...
      <article class="chart-card">
        ...
        <svg v-else class="trend-chart" viewBox="0 0 720 230" role="img" aria-labelledby="trend-title trend-desc">
          ...
          <defs><pattern id="estimatePattern" width="8" height="8" patternUnits="userSpaceOnUse" patternTransform="rotate(45)"><rect width="8" height="8" fill="var(--ib-primary-soft)"/><line x1="0" y1="0" x2="0" y2="8" stroke="var(--ib-primary)" stroke-width="3"/></pattern></defs>
          <line x1="42" y1="190" x2="700" y2="190" stroke="var(--ib-text-secondary)" stroke-width="1" />
...
<style scoped>
.dashboard-heading { display:flex;justify-content:space-between;gap:16px;padding-bottom:18px;border-bottom:1px solid var(--ib-border)}.dashboard-heading h2{margin:0;font-size:21px}.dashboard-heading p,.chart-card p{margin:5px 0 0;color:var(--ib-text-secondary);font-size:12px}.summary-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin:18px 0}.metric-card,.chart-card{padding:17px;border:1px solid var(--ib-border);border-radius:15px;background:var(--ib-surface)}.metric-card{display:grid;gap:8px}.metric-card>span{color:var(--ib-text-secondary);font-size:12px}.metric-card strong{font-size:23px}.metric-card small{color:var(--ib-text-secondary);font-size:11px}.chart-card{margin-bottom:12px}.chart-card h3{margin:0;font-size:15px}.trend-chart{width:100%;max-height:260px;margin-top:12px}.legend{display:flex;gap:20px;font-size:12px}.legend span{display:flex;align-items:center;gap:6px}.legend i{width:18px;height:10px;border-radius:2px}.estimate-key{background:repeating-linear-gradient(45deg,var(--ib-primary-soft) 0 4px,var(--ib-primary) 4px 6px)}.actual-key{background:var(--ib-primary)}.table-wrap{overflow-x:auto;margin-top:14px}table{width:100%;border-collapse:collapse;font-size:12px}th,td{padding:9px;border-bottom:1px solid var(--ib-border);text-align:left}th{color:var(--ib-text-secondary);background:var(--ib-primary-soft)}.detail-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}.no-data{padding:24px 8px;color:var(--ib-text-secondary);font-size:12px;text-align:center}.large-number{display:block;margin-top:18px;font-size:30px}.history{max-height:200px;overflow:auto;margin:12px 0 0;padding-left:20px}.history li{margin:9px 0}.history span,.history small{display:block}.history small{color:var(--ib-text-secondary)}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}
